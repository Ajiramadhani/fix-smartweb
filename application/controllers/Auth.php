...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('sukses', '<div class="alert alert-success" role="alert">Congrats! Your account has been created. Please activate your account</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'contohemailaji@gmail.com',
            'smtp_pass' => 'aji171850',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
        ...
        $this->email->from('contohemailaji@gmail.com', 'Setianto Aji');
    ...
    public function verify()
    {
        ...
        if ($user) {
            ...
            if ($user_token) {
                ...
                $this->session->set_flashdata('sukses', '<div class="alert alert-danger" role="alert">Account activation failed! Token Invalid!</div>');
                redirect('auth');
            }
        } else {
